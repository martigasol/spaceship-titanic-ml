...
The notebooks can then be run in Jupyter.
...
The main thing I wanted to get from this project was learning how a machine learning project works outside of just training a model.
...
- Looking at model errors
- Making a real Kaggle submission
- Exposing the model through an API

This gave me a much better idea of what an end-to-end ML workflow looks like in practice.
